...
public class FacadePedro {
    ...
    /**
     * Metodo para consultar por un criterio dado por el Administrador del sistema
    ...
    /**
     * metodo que valida  si el ID y la clave digitada coincide con la de la base de datos de la persona
     * @param id 
     * @param clave
     * @return la url de la vista del usuario correspondiente si el loggeo fue exitoso
     */
    ...
    /**
     * método que carga el nombre de los departamentos existentes en la Base de Datos en un <select>
    ...
    /**
     * método que carga los nombres de los municipios de acuerdo al departamento que se pasa como parámetro
     * @param departamento
     * @return un select con el nombre e id de todos los municipios del departamento que se pasa como parámetro 
     * @throws SQLException 
     */
     ...
     * @return Una cadena String en lenguaje HTML con los id y nombre de las haciendas
     */
    ...
    /**
     * Metodo que permite mostrar Datos de una hacienda en particular para su posterior modificacion
     * @param id numero de identificacion de la hacienda
     * @return codigo html con los datos de la hacienda para su posterior modificacion
     */
...
//    }
    ...
    //////////////////////////////////// facade Pedro Rico ///////////////////////////////////////////////////
     public boolean registraCorreccion(Correccion_suelo c, String nuevaEnmienda, String nuevaUnidad, String docPropietario) throws SQLException{
        System.out.println("ID LOTE --> "+c.getIdLote());
        return new PalmaPedro().registrarCorreccion(c, nuevaEnmienda, nuevaUnidad, docPropietario);
    }
    
    public String FormularioEditaCorreccionSuelo(String idCorreccion) throws SQLException{
        
        return new PalmaPedro().FormularioEditarCorreccionSuelo(idCorreccion);
    }
    
    public boolean editarCorreccionSuelo(Correccion_suelo c, String nuevaEnmienda, String nuevaUnidad, String docPropietario) throws SQLException{
        
        return new PalmaPedro().editarCorreccionSuelo(c, nuevaEnmienda, nuevaUnidad, docPropietario);
    }
    
    public String tablaCorrecionSuelo(String idLote){
        
        return new PalmaPedro().TablaCorreccionSuelos(idLote);
    }
    
    public boolean eliminarCorreccionSuelo(String idCorreccion){
        
        return new PalmaPedro().eliminarCorreccionSuelo(idCorreccion);
    }
     public String tablaSubtotalesCorreccionSuelo(String idLote){
        
        return new PalmaPedro().tablaSubtotalesCorreccionSuelos(idLote);
    }
     public boolean registraSiembraCobertura(Siembra_cobertura c, String nuevoInsumo, String nuevaUnidad, String docPropietario) throws SQLException{
        System.out.println("ID LOTE --> "+c.getIdLote());
        return new PalmaPedro().registrarCobertura(c, nuevoInsumo, nuevaUnidad, docPropietario);
    }
    public String FormularioEditaCobertura(String idCobertura) throws SQLException{
        
        return new PalmaPedro().FormularioEditarSiembraCobertura(idCobertura);
    }
     public boolean editarCobertura(Siembra_cobertura c, String nuevoInsumo, String nuevaUnidad, String docPropietario) throws SQLException{
        ...
        return new PalmaPedro().editarCobertura(c, nuevoInsumo, nuevaUnidad, docPropietario);
    }
      public String tablaSiembraCobertura(String idLote){
        
        return new PalmaPedro().TablaSiembraCoberturas(idLote);
    }
    
    public boolean eliminarSiembraCobertura(String idCobertura){
        
        return new PalmaPedro().eliminarSiembraCobertura(idCobertura);
    }
    public String tablaSubtotalesCobertura(String idLote){
        
        return new PalmaPedro().tablaSubtotalesSiembraCobertura(idLote);
    }
      public boolean registraOtro(Otro c, String nuevoItem, String nuevaUnidad, String docPropietario) throws SQLException{
        System.out.println("ID LOTE --> "+c.getIdLote());
        return new PalmaPedro().registrarOtro(c, nuevoItem, nuevaUnidad, docPropietario);
    }
    public String FormularioEditarOtro(String idOtro) throws SQLException{
        
        return new PalmaPedro().FormularioEditarOtros(idOtro);
    }
     public boolean editarOtro(Otro c, String nuevoItem, String nuevaUnidad, String docPropietario) throws SQLException{
        
        return new PalmaPedro().editarOtro(c, nuevoItem, nuevaUnidad, docPropietario);
     }
      public String tablaOtros(String idLote){
        
        return new PalmaPedro().TablaOtros(idLote);
    }
    
    public boolean eliminarOtro(String idOtro){
        
        return new PalmaPedro().eliminarOtro(idOtro);
    }
     public String tablaSubtotalesOtros(String idLote){
        
        return new PalmaPedro().tablaSubtotalesOtros(idLote);
    }
     
     public String selectUnidades(String tipoU) throws SQLException{
        
        return new PalmaPedro().selectUnidades(tipoU);
    }
      public String selectEnmiendas() throws SQLException{
        
        return new PalmaPedro().selectEnmiendas();
    }
       public String selectInsumos() throws SQLException{
        
        return new PalmaPedro().selectinsumos();
    }
        public String selectItems() throws SQLException{
        
        return new PalmaPedro().selectItems();
    }
}
