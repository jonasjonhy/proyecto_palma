...
public class CFAnimales {
    ...
    private double subtotalAnimales;
    ...
    /**
     * @return the subtotalAnimales
     */
    public double getSubtotalAnimales() {
        return subtotalAnimales;
    }

    /**
     * @param subtotalAnimales the subtotalAnimales to set
     */
    public void setSubtotalAnimales(double subtotalAnimales) {
        this.subtotalAnimales = subtotalAnimales;
    }
