...
public class BaseDeDatos {
   ...
   private static  String bd = "ufps_24";
    //private static  String bd = "palma_db";
    private static  String login = "ufps_24";
   //  private static  String login = "root";
  private static  String password = "ufps_pp";
 //       private static  String password = "";
   private static  String url = "jdbc:mysql://192.168.3.19:3306/"+bd;
