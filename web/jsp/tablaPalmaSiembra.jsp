<%-- 
    Document   : tablaPalmaSiembra
    Created on : 28/11/2014, 12:08:05 AM
    ...
    <body>
           ...
           <div class="container-fluyd row" >
            <div class="col-xs-3">
                ...
                <div class="col-xs-7 row" id="central" >
                       ...
                       <center><%=facadeMauricio.tablaPalmaSiembra(idLote)%></center>
                       
                       
                       <%--PARA LA PAGINACION--%>
                       <div id="navegacion"></div>
        <script type="text/javascript">
            var pager = new Pager("tablaSiembra",5);
            pager.init();
        ...
        <%--PARA LA PAGINACION--%>
                        ...
                        <br>
                            ...
                            <%=facadeMauricio.tablaSubtotalesPalmaSiembra(idLote)%>
...
<div class="modal fade" id="agregarCosto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
                    ...
                    <form action="../jsp/validarRegistroPalmaSiembra.jsp" method="post">
                                <div class="recuadro row blanco">  
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="date" id="fechaSiembra" name="fechaSiembra" class="form-control" placeholder="" required><br>
                                        <label>Area de Lote<label class="requerido"></label></label>
                                        <input type="text" id="areaLote" name="areaLote" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#cantidadPlantulas', '#precioPlantula')" required value="1"><br>
                                        
                                        <label>Cantidad por hectarea</label>
                                            <input type="text" id="cantidadPlantulas" name="cantidadPlantulas" class="form-control" onchange="cargarSubtotal3_registrar(this, '#areaLote', '#precioPlantula')" value="1" placeholder="" required><br> 
                                ...
                                <div class="col-sm-6 ">
                                        ...
                                        <input type="text" id="precioPlantula" name="precioPlantula" class="form-control" onchange="cargarSubtotal3_registrar(this, '#areaLote', '#cantidadPlantulas')" value="1" placeholder="" required><br>
                                        <label>Subtotal</label>
                                        <input type="text" id="subtotal" name="subtotal" class="form-control" placeholder="" readonly required value="0"><br>
                                        
                                 </div>
                                 <div class="col-sm-12"><center><button onclick="loading(load)" class="btn btn-success" type="submit">  Guardar</button><br></center></div>
                                </div> 
     ...
     <!-- Modal -->
<div class="modal fade" id="editarSiembra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    
      
      <div class="modal-body">     
          <%--div para cargar el formulario de edicion de la nivelacion.. se carga la info desde la BD--%>
          <div id="formEditarSiembra">
