                    ...
                    <form action="desactivarLote.jsp" method="post">
                        <div class="recuadro row blanco">  
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="cedulaCatastral" name="fecha" class="form-control" placeholder="" required><br>
                                <label>Labor<label class="requerido">*</label></label>
                                <select id="departamento" name="labor" class="form-control">
                                    <option value="0">1</option>
                                    <option value="1">otra</option>
                                </select><br>
                                <label>¿Otro? indicanos cual</label>
                                <input type="text" id="nombre" name="Otra" class="form-control" placeholder="otra"required><br>
                            </div>
                            <div class="col-sm-6 ">
                                <label>Metros Lineales</label>
                                <input type="text" id="nombre" name="Metros" class="form-control" placeholder=""required><br> 
                                <label>Precio por Metro Lineal</label>
                                <input type="text" id="telefono" name="precio" class="form-control" placeholder=""><br>
                                <label>Subtotal</label>
                                <input type="text" id="telefono" name="subtotal" class="form-control" placeholder="" readonly><br>
                            </div>
                            <div class="col-sm-12">
                ...
                <div class="modal-body">
                    <form action="desactivarLote.jsp" method="post">
                        <div class="recuadro row blanco">  
                            ...
                            <div class="col-sm-6 ">
                                <label>Area adecuada</label>
                                <input type="text" id="nombre" name="area" class="form-control" placeholder=""required><br>
