...
<html>
    ...
    <body>
        ...
        boolean elimino = facadeRosemberg.eliminarCostoAdministracion(idCosto);
        
        if(!elimino){
        %>
        <script type="text/javascript"> 
           
            alert("ERROR...NO SE HA PODIDO ELIMINAR EL REGISTRO DE COSTO DE ADMINISTRACION \n Vuelvalo a intentar")
        ...
        %>
            <script type="text/javascript"> 
                alert("EXITO...Se ha eliminado el registro de COSTO DE ADMINISTRACION!")
                location.href="../jsp/tablaAdministracion.jsp";
            </script>
        <%
        }
