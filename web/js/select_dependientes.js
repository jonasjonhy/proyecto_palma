...
function cargarFormularioEditarNivelacion(idNivelacion)
{
    var idNiv = document.getElementsById(idNivelacion);
    var ajax = nuevoAjax();
    ajax.open("GET","formularioEditarNivelacionNutriente.jsp?idNivelacion="+idNiv);
}
