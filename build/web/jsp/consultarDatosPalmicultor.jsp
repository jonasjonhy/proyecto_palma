<%-- 
    Document   : consultarDatosPalmilcultor
    Created on : 18/10/2014, 10:31:39 PM
...
<html lang="es">
    ...
    <body>
        ...
        <%
            ...
            String id = (String)sesionU.getAttribute("id");
            String nombrePropi = facade.consultarNombrePropietario(id);
        %>
            ...
            <div class="col-xs-3">
                    ...
                    <div class="btn-group-vertical" id="menu-botones">
                      <button type="button" class="btn btn-success btn-lg" onclick="location.href='../jsp/informacionPalmicultor.jsp'">Inicio</button><br>
                        <button type="button" class="btn btn-success btn-lg" onclick="location.href='../jsp/editarPalmicultor.jsp'">Editar Datos Personales</button><br>
                ...
                <div class="col-xs-7" id="central" >
                        ...
                        <center>
                          <h2 class="verde hidden-xs">Informacion de<span class="naranja"> Palmicultor</span></h2>
                          <h3 class="verde visible-xs">Informacion de<span class="naranja"> Palmicultor</span></h3>
                        </center>
                        <br><br>
                    <div class="table-responsive ">
                        ...
                        <%
                            String tablaInfo = facade.consultarInformacionPropietario(id);
                        %>
                        <%=tablaInfo%>
