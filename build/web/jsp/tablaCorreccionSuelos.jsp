    ...
    <body>
           ...
           <div class="container-fluyd row" >
            <div class="col-xs-3">
                ...
                <div class="col-xs-7 row" id="central" >
                       ...
                       <center><%=facadePedro.tablaCorrecionSuelo(idLote)%></center>
                       
                       
                       <%--PARA LA PAGINACION--%>
                       <div id="navegacion"></div>
        <script type="text/javascript">
            var pager = new Pager("tablaCorreccion",5);
            pager.init();
        ...
        <%--PARA LA PAGINACION--%>
                        ...
                        <br>
                            ...
                            <%=facadePedro.tablaSubtotalesCorreccionSuelo(idLote)%>
...
<div class="modal fade" id="agregarCosto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
                      <form action="../jsp/validarRegistroCorreccionSuelo.jsp" method="post">
                                <div class="recuadro row blanco">  

                                    <button type="button" class="close" data-dismiss="modal">
                                    <span aria-hidden="true">&times;</span>
                                    <span class="sr-only">Close</span></button>
                                    <center><h2 class="verde">Registro Correccion Suelo</h2></center>
                                    <br>
                                    

                                <div class="col-sm-6">
                                        <label>Fecha<label class="requerido"></label></label>
                                        <input type="date" id="fecha_aplicacion" name="fecha_aplicacion" class="form-control" placeholder="" required><br>
                                        <label>Area de Lote<label class="requerido"></label></label>
                                        <input type="text" id="area_aplicacion" name="area_aplicacion" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#cantidad', '#precio_enmienda')" required value="1"><br>
                                ...
                                <div class="col-sm-6 ">
                                        ...
                                        <label>Cantidad por hectarea</label>
                                            <input type="text" id="cantidad" name="cantidad" class="form-control" onchange="cargarSubtotal3_registrar(this, '#area_aplicacion', '#precio_enmienda')" value="1" placeholder="" required><br> 
                                    ...
                                    <div class="otraU">
                                        ...
                                        <label>Precio por unidad de la enmienda</label>
                                        <input type="text" id="precio_enmienda" name="precio_enmienda" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#area_aplicacion', '#cantidad')" value="1" required><br>
