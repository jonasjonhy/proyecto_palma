    ...
    <body>
            ...
            <div class="col-xs-3">
                    ...
                    <div class="btn-group-vertical" id="menu-botones">
                        ...
                        <button type="button" class="btn btn-success btn-lg dropdown-toggle" data-toggle="dropdown">Costos Establecimiento <span class="caret"></span></button>
                                ...
                                <li><a href="../jsp/tablaNivelacionNutriente.jsp">Nivelacion Nutrientes</a></li>
                ...
                <div class="col-xs-7 row" id="central" >
                       ...
                       <center><%=facadePedro.tablaSiembraCobertura(idLote)%></center>
                       
                       
                       <%--PARA LA PAGINACION--%>
                       <div id="navegacion"></div>
        <script type="text/javascript">
            var pager = new Pager("tablaCobertura",5);
            pager.init();
        ...
        <%--PARA LA PAGINACION--%>
                        ...
                        <br>
                            ...
                            <%=facadePedro.tablaSubtotalesCobertura(idLote)%>
...
<div class="modal fade" id="agregarCosto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
                      <form action="../jsp/validarRegistroSiembraCobertura.jsp" method="post">
                                <div class="recuadro row blanco">  

                                    <button type="button" class="close" data-dismiss="modal">
                                    <span aria-hidden="true">&times;</span>
                                    <span class="sr-only">Close</span></button>
                                    <center><h2 class="verde">Registro Otros Costos</h2></center>
                                    <br>
                                    

                                <div class="col-sm-6">
                                        <label>Fecha<label class="requerido"></label></label>
                                        <input type="date" id="fechaAplicacion" name="fecha_siembra" class="form-control" placeholder="" required><br>
                                        <label>Area de Lote<label class="requerido"></label></label>
                                        <input type="text" id="area_lote" name="area_lote" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#cantidad', '#precioUnidad')" required value="1"><br>
                                        
                                        <label>Insumo<label class="requerido">*</label></label>
                                        <select name="idFertilizante" id="idFertilizante" class="form-control" onchange="habilitarCampoOtroF_registro()" >
                                        <%=facadePedro.selectInsumos()%>
                                        
                                        <br>
                                    <div class="otroF">
                                        <label>¿Otro? indicanos cual</label>
                                            <input type="text" id="otroF" name="otroF" disabled = "disabled" class="form-control" placeholder="otro item" required><br>
                                     </div>   
                                ...
                                <div class="col-sm-6 ">
                                        ...
                                        <label>Cantidad por hectarea</label>
                                            <input type="text" id="cantidad" name="cantidad" class="form-control" onchange="cargarSubtotal3_registrar(this, '#area_lote', '#precioUnidad')" value="1" placeholder="" required><br> 
					   ...
					   <%=facadePedro.selectUnidades("peso")%>
                                    ...
                                    <div class="otraU">
                                        ...
                                        <label>Precio por unidad del Item</label>
                                        <input type="text" id="precioUnidad" name="precioUnidad" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#area_lote', '#cantidad')" value="1"><br>
                                        <label>Subtotal</label>
                                         ...
                                         <input type="text" id="precioAplicacion" name="precioAplicacion" class="form-control" onclick="cargarCostoAplicacion_registrar()" placeholder="" required><br>
