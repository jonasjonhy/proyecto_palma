<%-- 
    Document   : tablaCFAnimales
    Created on : 29/11/2014, 04:58:48 PM
    Author     : Oscar Torres
--%>
           ...
           <div class="container-fluyd row" >
            <div class="col-xs-3">
                ...
                <div class="col-xs-9 row" id="central" >             
                        <br><br><br><br><br>                       
                        <center><%=FacadeOscar.tablaCFAnimales(Integer.parseInt(hacienda))%></center>
                            ...
                            <table class="table table-bordered tablaP">                               
                                    <td class="negra">Total Costos Fijos de Animales</td>
                                    <td></td>
                                </tr>
                            </table>
                                    ...
                                    <div class="otraM">        
                                       ...
                                       <input type="text" id="areaServicio" name="areaServicio" class="form-control" placeholder="" onchange="cargarCostoHanio(this, '#preautil')"  value='0'><br>
                                        ...
                                        <label>Area total de Lotes</label>
                                            <input type="number" id="area_lotes" name="area_lotes"  class="form-control" placeholder="" onchange="cargarTotalM(this, '#costoHectarea')" ><br>
