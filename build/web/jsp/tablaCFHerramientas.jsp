<%-- 
    Document   : tablaCFHerramientas
    Created on : 29/11/2014, 04:59:23 PM
    Author     : Oscar Torres
--%>
...
<html lang="es">
    <head>
        ...
        <title>Costos Herramientas</title>
        <meta charset="UTF-8">
           ...
           <div class="container-fluyd row" >
            <div class="col-xs-3">
                ...
                <div class="col-xs-9 row" id="central" >             
                        <br><br><br><br><br>                       
                        <center><%=FacadeOscar.tablaCFHerramientas(Integer.parseInt(hacienda))%></center>
                                ...
                                <div class="recuadro row blanco">  
                                    ...
                                    <div class="otraM">        
                                       ...
                                       <input type="text" id="areaServicio" name="areaServicio" class="form-control" placeholder="" onchange="cargarCostoHanio(this, '#preautil')"  value='0'><br>
                                        ...
                                        <label>Subtotal Herramienta</label>
