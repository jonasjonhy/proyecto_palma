...
<html lang="es">
    <head>
        ...
        <title>Costos Fijos Tierra</title>
        <meta charset="UTF-8">
       ...
       <body>
        ...
        <div class="col-xs-7 row" id="central" >
                    ...
                    <br>
                           ...
                           <center><%=facadeRosemberg.tablaCostosTierra(hacienda)%></center>
                           
                                                   <%--PARA LA PAGINACION--%>
                       <div id="navegacion"></div>
        <script type="text/javascript">
            var pager = new Pager("tablaCostosTierra",5);
            pager.init();
        ...
        <%--PARA LA PAGINACION--%>
                        ...
                        <br>
                            ...
                            <%=facadeRosemberg.tablaSubtotalesCostoTierra(hacienda)%>
                </div>
          </div>
...
<div class="modal fade" id="agregarCosto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form action="validarRegistroCostoTierra.jsp" method="post">
                                <div class="recuadro row blanco">  
                                    ...
                                    <label>Fecha<label class="requerido"></label></label>
                                        ...
                                        <input type="text" id="area" name="area" class="form-control" placeholder="" readonly>
                                        <br>
