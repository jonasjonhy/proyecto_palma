    ...
    <body>
           ...
           <div class="container-fluyd row" >
            <div class="col-xs-3">
                ...
                <div class="col-xs-7 row" id="central" >
                       ...
                       <center><%=facadePedro.tablaOtros(idLote)%></center>
        ...
        <%--PARA LA PAGINACION--%>
                        ...
                        <br>
                            ...
                            <%=facadePedro.tablaSubtotalesOtros(idLote)%>
...
<div class="modal fade" id="agregarCosto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
                      <form action="../jsp/validarRegistroOtros.jsp" method="post">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <input type="date" id="fecha_activacion" name="fecha_activacion" class="form-control" placeholder="" required><br>
                                        <label>Area de Lote<label class="requerido"></label></label>
                                        <input type="text" id="areaLote" name="areaLote" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#cantidadItem', '#precioItem')" required value="1"><br>
                                        
                                        <label>Item<label class="requerido">*</label></label>
                                        <select name="idItem" id="idItem" class="form-control" onchange="habilitarCampoOtroI_registro()" >
                                        <%=facadePedro.selectItems()%>
                                        
                                        <br>
                                    <div class="otroF">
                                        <label>¿Otro? indicanos cual</label>
                                            <input type="text" id="otroI" name="otroI" disabled = "disabled" class="form-control" placeholder="otro item"required><br>
                                     </div>   
                                ...
                                <div class="col-sm-6 ">
                                        ...
                                        <label>Cantidad por hectarea</label>
                                            <input type="text" id="cantidadItem" name="cantidadItem" class="form-control" onchange="cargarSubtotal3_registrar(this, '#areaLote', '#precioItem')" value="1" placeholder="" required><br> 
					   ...
					   <%=facadePedro.selectUnidades("peso")%>
                                    ...
                                    <div class="otraU">
                                        ...
                                        <input type="text" id="precioItem" name="precioItem" class="form-control" placeholder="" onchange="cargarSubtotal3_registrar(this, '#cantidadItem', '#areaLote')" value="1"><br>
